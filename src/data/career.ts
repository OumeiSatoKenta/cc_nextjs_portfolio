...
export const careers: Career[] = [
  {
    ...
    period: { start: '2023-06' },
    description:
      '2023 年 6 月にオルトプラス正社員として入社。当初は SES 形態で複数のクライアント案件に参画し、2026 年 2 月から自社モバイルゲームプロジェクトに従事。',
    engagements: [
      {
        client: '自社モバイルゲームプロジェクト',
      ...
      {
        client: 'モバイルゲーム企業 A 社',
        engagementType: 'ses',
        role: 'SRE エンジニア',
        period: { start: '2025-10', end: '2026-04' },
        description:
          'SES 形態で参画。モバイルゲーム 2 タイトルのライブインフラを 1 人で担当。Google Cloud 全環境を Terraform で構築。',
        achievements: [
      ...
      {
        client: '大手美容メディア企業 B 社',
        engagementType: 'ses',
        role: 'DBRE エンジニア',
        period: { start: '2024-10', end: '2025-09' },
        description:
          'SES 形態で参画。大規模美容メディアのオンプレ DB サーバーを AWS DMS 経由で TiDB へ移行するプロジェクトを担当。',
        achievements: [
      ...
      {
        client: '大手 Web プラットフォーム企業 C 社',
        engagementType: 'ses',
        role: 'SRE メイン担当',
        period: { start: '2023-06', end: '2024-09' },
        description:
          'SES 形態で参画。オンラインクレーンゲームサービスの SRE として、ユーザー規模約 4 倍の成長フェーズを支える。',
        achievements: [
